export function rollOwnedItem(itemName, rollOptions = false) {
  ...
  if (!actor) return ui.notifications.warn(game.i18n.localize("the-expanse.WARNING.selectTokenMacro"));

  const itemRolled = actor ? actor.items.find(i => i.name === itemName) : null;
  if (!itemRolled) {return ui.notifications.warn(game.i18n.localize("the-expanse.WARNING.actorDontHaveValidItem"));}
