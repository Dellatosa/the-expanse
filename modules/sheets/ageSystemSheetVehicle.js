...
export default class ageSystemVehicleSheet extends ActorSheet {
    ...
    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            ...
            height: 755,
            resizable: false,
            classes: ["the-expanse", "sheet", "vehicle"/*, `colorset-${ageSystem.colorScheme}`*/]
        });
    }
    ...
    _onRollManeuver(event) {
        ...
        const rollData = {
            ...
            actor: user,
            abl: handlingUseAbl,
            flavor: game.i18n.format("the-expanse.chatCard.maneuversVehicle", {name: user.name, vehicle: this.actor.name}),
