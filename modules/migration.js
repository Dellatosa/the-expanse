...
export const migrateWorld = async function() {
  ...
  game.settings.set("the-expanse", "systemMigrationVersion", game.system.data.version);
...
export const migrateCompendium = async function(pack) {
  ...
  for ( let doc of documents ) {
    ...
    // Handle migration failures
      ...
      err.message = `Failed the-expanse system migration for entity ${doc.name} in pack ${pack.collection}: ${err.message}`;
      console.error(err);
    }
  }
...
export const migrateItemData = function(item) {
  const lastMigrationVer = game.settings.get("the-expanse", "systemMigrationVersion");
  const updateData = {};
