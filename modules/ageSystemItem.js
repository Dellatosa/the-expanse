...
export class ageSystemItem extends Item {
    ...
    get hasFatigue() {
        if (this.data.type === "power" && this.data.data.useFatigue) {return game.settings.get("the-expanse", "useFatigue")};
        return false;
    };
    ...
    prepareBaseData() {
        ...
        data.colorScheme = `colorset-${game.settings.get("the-expanse", "colorScheme")}`;
    ...
    _preparePower(data) {
        const useFatigue = game.settings.get("the-expanse", "useFatigue");
            ...
            switch (rollType) {
                ...
                case "attack":
                    ...
                    if (targets.size > 1) {
                        ...
                        let warning = game.i18n.localize("the-expanse.WARNING.selectOnlyOneTarget");
    ...
    chatTemplate = {
        "weapon": "systems/the-expanse/templates/sheets/weapon-sheet.hbs",
        "focus": "systems/the-expanse/templates/sheets/focus-sheet.hbs",
        "stunts": "systems/the-expanse/templates/sheets/stunts-sheet.hbs",
        "talent": "systems/the-expanse/templates/sheets/talent-sheet.hbs",
        "equipment": "systems/the-expanse/templates/sheets/equipment-sheet.hbs",
        "power": "systems/the-expanse/templates/sheets/power-sheet.hbs",
        "relationship": "systems/the-expanse/templates/sheets/relationship-sheet.hbs",
        "honorifics": "systems/the-expanse/templates/sheets/honorifics-sheet.hbs",
        "membership": "systems/the-expanse/templates/sheets/membership-sheet.hbs",
        "shipfeatures": "systems/the-expanse/templates/sheets/shipfeatures-sheet.hbs"
    };
    ...
    async showItem(forceSelfRoll = false) {
        ...
        const cardData = {
            ...
            colorScheme: game.settings.get("the-expanse", "colorScheme"),
            config: {wealthMode: game.settings.get("the-expanse", "wealthType")}
        };
        const chatData = {
            user: game.user.id,
